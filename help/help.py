...
class Help(commands.Cog):
    ...
    async def add_xingamento(self, ctx):  
        ...
        em.add_field(
            name="**Exemplo de uso:**",
            value="```pet.add_xingamento <xingamento a ser adicionado>```",
            inline=False
        )
        await ctx.send(embed = em)
    ...
    async def rem_xingamento(self, ctx):  
        ...
        em.add_field(
            name="**Exemplo de uso:**",
            value="```pet.rem_xingamento <xingamento a ser removido>```",
            inline=False
        )
        await ctx.send(embed = em)
    ...
    async def add_elogio(self, ctx):  
        ...
        em.add_field(
            name="**Exemplo de uso:**",
            value="```pet.add_elogio <elogio a ser adicionado>```",
            inline=False
        )
        await ctx.send(embed = em)
    ...
    async def rem_elogio(self, ctx):  
        ...
        em.add_field(
            name="**Exemplo de uso:**",
            value="```pet.rem_elogio <elogio a ser removido>```",
            inline=False
        )
        await ctx.send(embed = em)
    ...
    async def add_interpet(self, ctx):  
        ...
        em.add_field(
            name="**Exemplo de uso:**",
            value="```pet.add_interpet <dd/mm/aaaa>```",
            inline=False
        )
        await ctx.send(embed = em)
    ...
    async def rem_interpet(self, ctx):  
        ...
        em.add_field(
            name="**Exemplo de uso:**",
            value="```pet.rem_interpet <dd/mm/aaaa>```",
            inline=False
        )
        await ctx.send(embed = em)
    ...
    @help.command()
    async def peguei(self, ctx):
        em = discord.Embed(
            title="**Comando: peguei a chave**",
            description="Use quando a chave da salinha estiver em suas mãos.",
            color=0xFFFFFF
        )
        em.add_field(
            name="**Exemplo de uso:**",
    ...
    @help.command()
    async def devolvi(self, ctx):
        em = discord.Embed(
            title="**Comando: devolvi a chave**",
            description="Use quando tiver deixado a chave de volta na recepção.",
            color=0xFFFFFF
        )
        em.add_field(
            name="**Exemplo de uso:**",
    ...
    @help.command()
    async def passei(self, ctx):
        em = discord.Embed(
            title="**Comando: passei a chave**",
            description="Use quando tiver deixado a chave nas mãos de um outro alguém.",
            color=0xFFFFFF
        )
        em.add_field(
            name="**Exemplo de uso:**",
            value="```pet.devolvi <@ do fulaninho>```",
            inline=False
        )
        await ctx.send(embed = em)

    @help.command()
    async def chave(self, ctx):
        em = discord.Embed(
            title="**Comando: com quem está a chave?**",
            description="Use quando estiver com dúvidas sobre quem está atualmente com a chave.",
            color=0xFFFFFF
        )
        em.add_field(
            name="**Exemplo de uso:**",
    ...
    async def clear(self, ctx):
        em = discord.Embed(
            title="**Comando: clear?**",
            description="Use para limpar o <#994742074874269787>.",
            color=0xFFFFFF
        )
        em.add_field(
            name="**Exemplo de uso:**",
